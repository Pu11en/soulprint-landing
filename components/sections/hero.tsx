            ...
            <section className="lg:hidden relative flex flex-col min-h-[100dvh] w-full overflow-hidden bg-black">
                ...
                <div className="relative flex-1 flex flex-col items-center justify-center px-6 z-10">
                    ...
                    >
                        ...
                        >
                            <span className="text-black font-bold text-lg uppercase tracking-wide">Get Started</span>
            ...
            <section className="hidden lg:flex relative flex-col min-h-screen w-full overflow-hidden bg-black">
                ...
                <div className="relative flex-1 flex flex-col items-center justify-center px-8 z-10">
                    ...
                    >
                        ...
                        >
                            <span className="text-black font-bold text-xl uppercase tracking-wide">Get Started</span>
